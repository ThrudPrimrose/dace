...
# Overlaps test_nested_matrix_gather_load_specialized (harder)
...
# Overlaps test_halve_index_s4117 (TSVC-style chained ops, harder)
...
# Overlaps test_div_index_symbol (symbolic divisor, harder)
